...
namespace model_model_unconstrained_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model_unconstrained");
    reader.add_event(44, 42, "end", "model_model_unconstrained");
    return reader;
}
#include <stan_meta_header.hpp>
class model_model_unconstrained
  : public stan::model::model_base_crtp<model_model_unconstrained> {
private:
        int K;
        std::vector<int> y1;
        std::vector<int> y2;
        ...
        double b2;
public:
    model_model_unconstrained(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_model_unconstrained_namespace::model_model_unconstrained";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("theta", "(K - 1)", (K - 1));
        context__.validate_dims("parameter initialization", "theta", "vector_d", context__.to_vec((K - 1)));
        Eigen::Matrix<double, Eigen::Dynamic, 1> theta((K - 1));
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                theta = in__.vector_constrain((K - 1), lp__);
            else
                theta = in__.vector_constrain((K - 1));
            current_statement_begin__ = 11;
            ...
            for (int k = 1; k <= (K - 1); ++k) {
                ...
                stan::model::assign(gamma2, 
                            ...
                            (get_base1(alpha, k, "alpha", 1) - (.5 * get_base1(theta, k, "theta", 1))), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_model_unconstrained_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        Eigen::Matrix<double, Eigen::Dynamic, 1> theta = in__.vector_constrain((K - 1));
        size_t theta_j_1_max__ = (K - 1);
        for (size_t j_1__ = 0; j_1__ < theta_j_1_max__; ++j_1__) {
    ...
    std::string model_name() const {
        return "model_model_unconstrained";
    }
...
typedef model_model_unconstrained_namespace::model_model_unconstrained stan_model;
#ifndef USING_R
