...
#include "stanExports_model_unconstrained.h"

RCPP_MODULE(stan_fit4model_unconstrained_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_model_unconstrained")
