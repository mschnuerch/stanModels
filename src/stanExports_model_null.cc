...
#include "stanExports_model_null.h"

RCPP_MODULE(stan_fit4model_null_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_model_null")
