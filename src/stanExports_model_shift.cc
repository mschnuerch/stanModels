...
#include "stanExports_model_shift.h"

RCPP_MODULE(stan_fit4model_shift_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_model_shift")
